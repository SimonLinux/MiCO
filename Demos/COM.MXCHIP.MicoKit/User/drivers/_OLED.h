...
#define OLED_CS_SET()     	  MicoGpioOutputHigh( (mico_gpio_t)OLED_CS_PIN );
#define OLED_CS_RESET()		  MicoGpioOutputLow( (mico_gpio_t)OLED_CS_PIN );	

#define OLED_DC_SET()     	  MicoGpioOutputHigh( (mico_gpio_t)OLED_DC_PIN );  
#define OLED_DC_RESET()		  MicoGpioOutputLow( (mico_gpio_t)OLED_DC_PIN );	
